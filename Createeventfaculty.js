...
const Createeventfaculty = ({navigation}) => {
    const [selectedGender, setSelectedGender] = useState(null);
    const [senoiurfaculty, setsenoiurfaculty] = useState('');
    const [juniorfaculty, setjuniorfaculty] = useState('');
...
<View style={{flexDirection:'row',justifyContent:'space-evenly',marginTop:hp(2)}}>
  <TouchableOpacity
    ...
    <Picker
            selectedValue={senoiurfaculty}
            onValueChange={val => {
              setsenoiurfaculty(val);
            }}
            style={{
              alignItems: 'center',
            ...
            <Picker.Item label="Sir Umer" value="Sir Umer" />
            <Picker.Item label="sir Zahid" value="sir Zahid" />
            <Picker.Item label="sir Hassan" value="sir Hassan" />
    ...
    <Picker
            selectedValue={juniorfaculty}
            onValueChange={val => {
              setjuniorfaculty(val);
            }}
            style={{
              alignItems: 'center',
              backgroundColor: '#f0f0f0',
              ...
              color:'black',
               ...
               <Picker.Item label="All" value="All" />
            <Picker.Item label="Sir waqar" value="Sir waqar" />
            <Picker.Item label="Mam sanam" value="Mam sanam" />
            <Picker.Item label="Mam Nadia" value="Mam Nadia" />
...
export default Createeventfaculty;
