...
const Createeventsociety = ({navigation}) => {

    const [selectedGender, setSelectedGender] = useState(null);
    const [societymember, setsocietymember] = useState('');
...
<View style={{flexDirection:'row',justifyContent:'space-evenly',marginTop:hp(2)}}>
  <TouchableOpacity
    ...
    <Picker
            selectedValue={societymember}
            onValueChange={val => {
              setsocietymember(val);
            }}
            style={{
              alignItems: 'center',
...
export default Createeventsociety;
